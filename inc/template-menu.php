...
function webionlite_main_menu() {
	...
	<nav id="site-navigation" class="<?php echo join( ' ', $classes ); ?>" role="navigation">
		...
		<?php
			$args = apply_filters( 'webionlite-theme/menu/main-menu-args', array(
				'theme_location'   => 'main',
				'container'        => '',
				'menu_id'          => 'main-menu',
				'fallback_cb'      => 'webionlite_set_nav_menu',
				'fallback_message' => esc_html__( 'Set main menu', 'webionlite' ),
			) );
 ...
 * @return void
 */
function webionlite_footer_menu() { ?>
	<nav id="footer-navigation" class="footer-menu" role="navigation">
	<?php
		$args = apply_filters( 'webionlite-theme/menu/footer-menu-args', array(
			...
			'fallback_message' => esc_html__( 'Set footer menu', 'webionlite' ),
		) );
 ...
 * @return string
 */
function webionlite_get_social_list( $context, $type = 'icon' ) {
	static $instance = 0;
	$instance++;
	...
	$args = apply_filters( 'webionlite-theme/social/list-args', array(
		...
		'echo'             => false,
		'fallback_cb'      => 'webionlite_set_nav_menu',
		'fallback_message' => esc_html__( 'Set social menu', 'webionlite' ),
	), $context, $type );
 ...
 * @return void
 */
function webionlite_set_nav_menu( $args ) {
