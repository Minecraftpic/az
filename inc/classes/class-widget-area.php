...
if ( ! class_exists( 'WebionLite_Widget_Area' ) ) {

	class WebionLite_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'webionlite-theme/widget-area/render', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'webionlite-theme/widget_area/rendering_current', $area_id );
			...
			$classes = apply_filters( 'webionlite-theme/widget_area/classes', $classes, $area_id );
	...
	function webionlite_widget_area() {
		return WebionLite_Widget_Area::get_instance();
	}

	webionlite_widget_area();
}
